...
A curated list of awesome Dart frameworks, libraries, and software. Items on the list are actively maintained, well documented, and popular in the Dart community. Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,866 | 🐛 100 | 📅 2026-06-30 lists.

### Contributing

Please take a quick look at the [contribution guidelines](/CONTRIBUTING.md) first. If you see a package or project here that is no longer maintained or is not a good fit, please submit a pull request to improve this file. Thank you to all [contributors](https://github.com/yissachar/awesome-dart/graphs/contributors) ⭐ 2,489 | 🐛 23 | 📅 2026-05-24; you rock!
...
* [Dart Frog](https://github.com/VeryGoodOpenSource/dart_frog) ⭐ 2,270 | 🐛 109 | 🌐 Dart | 📅 2026-08-01 -  A fast, minimalistic backend framework for Dart.
...
* [Rikulo Stream](https://github.com/rikulo/stream) ⭐ 237 | 🐛 0 | 🌐 Dart | 📅 2026-06-01 - Lightweight web server with request routing, filtering, template engine, WebSocket, MVC design pattern, and file-based static resources.
...
* [Rapid Open Hardware Development (ROHD) Framework](https://github.com/intel/rohd) ⭐ 489 | 🐛 137 | 🌐 Dart | 📅 2026-08-10 - A framework for describing and verifying hardware.

## Cross-platform development

* [universal\_io](https://github.com/terrier989/universal_io) ⭐ 101 | 🐛 10 | 🌐 Dart | 📅 2025-11-16 - *dart:io* that also works in the browser.
* [universal\_html](https://github.com/terrier989/universal_html) ⭐ 0 | 🐛 0 | 🌐 Dart | 📅 2023-09-07 - *dart:html* that also works in the VM/Flutter.

## Game Development

* [Flame](https://github.com/luanpotter/flame#readme) ⭐ 10,723 | 🐛 89 | 🌐 Dart | 📅 2026-08-14 - A minimalist Flutter game engine.
...
* [Universal Tween Engine](https://github.com/xaguzman/tween-engine-dart) ⭐ 35 | 🐛 2 | 🌐 Dart | 📅 2019-03-12 - A port of the original java Universal Tween Engine created by Aurelien Ribbon.
* [Spine Dart](https://github.com/FedeOmoto/spine) ⭐ 21 | 🐛 0 | 🌐 Dart | 📅 2014-11-28 - An implementation of the Esoteric Software Spine runtime.

## Template

* [mason](https://github.com/felangel/mason) ⭐ 1,134 | 🐛 100 | 🌐 Dart | 📅 2026-06-03 - Tools which allow developers to create and consume reusable templates called bricks.
...
* [built\_value](https://github.com/google/built_value.dart) ⭐ 885 | 🐛 95 | 🌐 Dart | 📅 2026-08-05 - Immutable value types, enum classes, and serialization.
...
* [package: inject](https://github.com/google/inject.dart) ⚠️ Archived - Compile-time dependency injection for Dart and Flutter
* [Dependencies](https://github.com/marcguilera/dependencies.dart) ⭐ 31 | 🐛 4 | 🌐 Dart | 📅 2021-11-05 - A simple and modular dependency injection system which doesn't use mirrors.
* [Angular DI](https://webdev.dartlang.org/angular/guide/dependency-injection) - Dependency Injection framework by Angular.

## Parsers

* [PetitParser](https://github.com/petitparser/dart-petitparser) ⭐ 486 | 🐛 5 | 🌐 Dart | 📅 2026-08-12 - PetitParser combines ideas from scannerless parsing, parser combinators, parsing expression grammars and packrat parsers to model grammars and parsers as objects that can be reconfigured dynamically.
...
* [Objectory](https://github.com/vadimtsushko/objectory) ⭐ 55 | 🐛 9 | 🌐 Dart | 📅 2016-11-26 - Objectory provides typed, checked environment to model, save and query data persisted on MongoDb.

## Image

* [image](https://github.com/brendan-duncan/image) ⭐ 1,262 | 🐛 56 | 🌐 Dart | 📅 2026-08-05 - Provides server and web apps the ability to load, manipulate, and save images with various image file formats including PNG, JPEG, GIF, WebP, TIFF, TGA, PSD, PVR, and OpenEXR.

## Testing

* [Guinness](https://github.com/vsavkin/guinness) ⭐ 42 | 🐛 7 | 🌐 Dart | 📅 2016-04-06 - A port of the Jasmine library.
...
* [Freezed](https://github.com/rrousselGit/freezed) ⭐ 2,190 | 🐛 118 | 🌐 Dart | 📅 2026-08-11 - Code generation for immutable classes that has a simple syntax/API without compromising on the features.

## Crash monitoring

* [Sentry](https://github.com/getsentry/sentry-dart) ⭐ 871 | 🐛 134 | 🌐 Dart | 📅 2026-08-13 - Sentry provides self-hosted and cloud-based error monitoring that helps all software teams discover, triage, and prioritize errors in real-time.
...
* [webdev\_proxy](https://github.com/Workiva/webdev_proxy) ⭐ 11 | 🐛 3 | 🌐 JavaScript | 📅 2026-07-31 - A proxy wrapper around [webdev](https://github.com/dart-lang/webdev) ⭐ 224 | 🐛 213 | 🌐 Dart | 📅 2026-08-15 which adds support for rerouting 404s to the index, allowing for HTML push-based routing while running locally.
